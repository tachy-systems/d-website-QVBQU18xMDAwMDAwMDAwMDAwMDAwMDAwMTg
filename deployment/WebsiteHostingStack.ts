...
export class WebsiteHostingStack extends Stack {
     constructor(scope: App, name: string, certStack: GlobalCertificateStack, props: MyStaticSiteProps) {
          super(scope, name, props);

          let {domainName, stage, sourceCodeFolderPathDev, exclude} = props;
          ...
          new s3deploy.BucketDeployment(this, logicalBucketDeployment, {
               sources: [s3deploy.Source.asset(sourceCodeFolderPathDev, {exclude: exclude})],
